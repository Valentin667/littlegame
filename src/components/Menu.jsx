        ...
        <>
            <div className={`menu ${
                ...
                <button
                    ...
                    onClick={() => startGame({mode: "hiragana"})}>Start hiragana game
                </button>
                <button
                    disabled={gameState !== gameStates.MENU}
                    onClick={() => startGame({mode: "katakana"})}>Start katakana game
                </button>
            </div>
            <div 
                className={`scores ${
            ...
            >
                <h1>Congratulation you are the becoming a true master</h1>
                <button 
                    onClick={goToMenu} 
